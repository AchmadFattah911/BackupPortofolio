        ...
        >
            <div class="bg-white dark:bg-gray-800 shadow-xl rounded-2xl p-8 transform transition duration-300 hover:scale-105 border border-gray-100 dark:border-gray-700">
                ...
                <form action="{{ route('projects.update', $project->id) }}" method="POST" class="space-y-8">
                    @csrf
                    @method('PUT') <div>
                        <label class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2 uppercase tracking-wide">Project Title</label>
                        <input
                            type="text"
                            name="title"
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows="5"
                            class="w-full px-4 py-3 rounded-xl border border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-white focus:ring-2 focus:ring-indigo-500 focus:outline-none transition duration-300 shadow-sm resize-none"
